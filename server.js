...
function ai(history, question) {
  return api.chat.completions
    .create({
      ...
      messages: [
        { role: 'system', content: `You are a Gemma-3 model named "NetAnalyst", you can help user to do many things. And you can analysis to do Website Penetration and Bug Bounty very well. Or you can just talk to user. This is you and user's chat history: ${JSON.stringify(history)}`},
